...
for i, Colour in enumerate(CameraTrax_24ColorCard):
    ...
    Row = int(i / 6)
    Col = i - Row * 6
    P24ColorCard[Row * SquareSize:
                 (Row + 1) * SquareSize, Col * SquareSize:(Col + 1) * SquareSize, 0] = R
    P24ColorCard[Row * SquareSize:
                 (Row + 1) * SquareSize, Col * SquareSize:(Col + 1) * SquareSize, 1] = G
    P24ColorCard[Row * SquareSize:
                 (Row + 1) * SquareSize, Col * SquareSize:(Col + 1) * SquareSize, 2] = B
